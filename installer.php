...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210801_valarieregas_5d1a2ee6d7b93de14793_20210801191851_archive.daf';
	const ARCHIVE_SIZE		 = '101076726';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5d1a2ee-01191851';
    const SECONDARY_PACKAGE_HASH = 'dde1f4e-01191851';
	const VERSION			 = '1.4.2';
